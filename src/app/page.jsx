      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I&apos;m Nathan, a web developer and digital marketing specialist
            based in Montana. I am a data-driven digital marketer, specializing
            in light-weight web applications, SEO, and SEM.
          </p>
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://github.com/Nathan-reitan"
